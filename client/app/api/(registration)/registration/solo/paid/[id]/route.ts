...
export async function POST(
  ...
  try {
    ...
    const newRegistration = new Registration({
      ...
      isInTeam: false,
      participant: session.user.id,
      verified: false, // Non-verified by default for paid events
    });
    ...
    return NextResponse.json(
      {
        message: `Registered for ${event.eventName}! Complete payment to confirm your registration.`,
        isVerified: true,
    ...
    console.error("Registering in Solo Paid Event Error:", error);
    return NextResponse.json(
